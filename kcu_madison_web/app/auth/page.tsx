  ...
  return (
    <div className="min-h-screen bg-black text-white relative">
      ...
      <div className="white-rectangle left-[480px] top-[250px] absolute px-2">
        <p style={{ fontSize: '25px' }} className="font-decor">
          ◆ System Control.Auth
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="font-navbar absolute left-[680px] top-[320px]">
          <p style={{ fontSize: '70px' }} className="ml-[50px]">
            Type the password.
          </p>
          <input
            type="text"
          ...
          />
          <p style={{ fontSize: '19px' }} className="font-decor ml-[15px] -mt-[90px]">
            ♬ hint: iykyk
          </p>
          <button
            type="submit"
          ...
          {isAuthenticated && (
            <p className="text-green-500 font-decor mt-4">Access Granted!</p>
          )}
          {error && <p className="text-red-500 font-decor mt-4">{error}</p>}
        </div>
      </form>
    </div>
  );
